      ...
      try {
        ...
        if (
          ...
          results.push({
            ...
            success: true,
            message: responseData.body?.message || "Notebook deleted successfully",
          });
        } else {
          ...
          results.push({
            ...
            id,
            success: false,
            message: responseData.body?.message || "Failed to delete notebook",
          });
        }
      } catch (error) {
      ...
      try {
        ...
        if (
          ...
          results.push({
            ...
            id: responseData.body?.id || id,
            success: true,
            message: responseData.body?.message || "Notebook updated successfully",
          });
        } else {
          ...
          results.push({
            ...
            id,
            success: false,
            message: responseData.body?.message || "Failed to update notebook",
          });
        }
      } catch (error) {
